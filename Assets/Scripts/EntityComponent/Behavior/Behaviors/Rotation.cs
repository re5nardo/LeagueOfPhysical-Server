...
namespace Behavior
{
    public class Rotation : BehaviorBase
    {
        ...
        protected override void OnBehaviorStart()
        {
            ...
            LOP.Game.Current.GameEventManager.SendToNear(new EntityBehaviorStart(Entity.EntityID, m_MasterData.ID, (SerializableVector3)m_vec3Direction), Entity.Position);
        }
